...
(function () {
    ...
    app.run(['$templateCache', function ($templateCache) {
        ...
        $templateCache.put('uib/template/tabs/tabset.html',
            "<div class=\"clearfix\"><ul class=\"tab-nav\" ng-class=\"{'tn-vertical': vertical, 'tn-justified': justified, 'tab-nav-right': right}\" ng-transclude></ul><div class=\"tab-content\"><div class=\"tab-pane\" ng-repeat=\"tab in tabset.tabs\" ng-class=\"{active: tab.active}\" uib-tab-content-transclude=\"tab\"></div></div></div>"
        );
